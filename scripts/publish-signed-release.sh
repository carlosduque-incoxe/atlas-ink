...
gh release create "$version" \
  ...
  --repo "$repo" --target "$(git rev-parse HEAD)" --title "Atlas Ink $version" \
  --notes "Signed Atlas Ink firmware for XTEINK X4 (ESP32-C3). Built and verified locally; manual OTA promotion."